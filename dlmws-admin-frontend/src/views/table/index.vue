<template>
  <div class="app-container">
    ...
    <el-form :inline="true"  size="mini" class="demo-form-inline">
      ...
      <el-form-item label="项目">
        <el-select v-model="tomcatVo.project" placeholder="项目">
          <el-option label="dlmws-log" value="dlmws-log"></el-option>
          <el-option label="dlmws-agent" value="dlmws-agent"></el-option>
        </el-select>
      </el-form-item>
    ...
    <el-form :inline="true" size="mini" class="demo-form-inline">
      ...
      <el-form-item>
        <el-button type="info" icon="el-icon-delete" @click="clearForm">清空</el-button>
      </el-form-item>
    </el-form>
    <el-table
      size="mini"
